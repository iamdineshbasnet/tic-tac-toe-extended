		...
		<main className="mt-12 text-center">
				...
				<section className="flex justify-between gap-20 max-w-[600px] mx-auto mt-60">
						<div className="w-full">
							{creator ? <UserCard showMark={false} data={creator} /> :  <UserCard showMark={false} data={you} />}
						</div>
						<div className="w-full">
							{otherPlayer ? <UserCard showMark={false} data={otherPlayer} /> : <UserCard showMark={false} data={opponent} />	}						
						</div>
					</section>
		</main>
	);
