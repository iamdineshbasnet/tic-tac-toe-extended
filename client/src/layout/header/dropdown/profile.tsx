	...
	return (
		<DropdownMenu>
			...
			<DropdownMenuContent align="end">
				<DropdownMenuItem className='cursor-pointer' onClick={()=>handleNavigation('account')}>My Account</DropdownMenuItem>
				<DropdownMenuItem className='cursor-pointer' onClick={()=>handleNavigation('avatars')}>Change Avatar</DropdownMenuItem>
				{player?.isGuest ? (
